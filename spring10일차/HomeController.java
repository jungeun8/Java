...
public class HomeController {
	...
	/**
	 * 회원가입화면으로 내부이동하는 요청햄들러 메소드 
	 * 요청 URL : localhost/spring-mvc/register
	 * @return
	 */
	@GetMapping("/register")
	public String registerform() {
		logger.info("회원가입 폼을 요청을 처리함");
		return "form";
	}
	...
	*/
	...
	public String register(UserRegisterForm userRegisterForm) {
		...
		// User 객체를 생성하고, UserRegisterForm값을 User객체로 복사한다.
		User user = new User();
		BeanUtils.copyProperties(userRegisterForm, user);
		
		//userService의 registerUser를 호출해서 업무로직을 수행한다.
