...
public class StringApp2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("첫번쨰 등장위차: " + index1);
		System.out.println("마지막번쨰 등장위차: " + index2);
		
		// String substring(int beginIndex)
		// 지정된 위치에서 문자열의 끝까지 해당하는 글자로 구성된 문자열을 반환한다.
		...
		System.out.println("3번쨰부터 7번쨰 앞까지: " + str6);
		...
		// 해당 문자열을 소문자, 대문자로 바뀐 새로운 분자열을 반환한다. 
