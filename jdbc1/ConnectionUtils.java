...
public class ConnectionUtils {
	...
	private static final String DRUVER_CLASS_NAME = "oracle.jdbc.OracleDriver";
	private static final String URL = "jdbc:oracle:thin:@192.168.50.55:1521:xe";
	...
	static {
		try {
			// oracle jdbc 드라이브는 로딩한다. 
			Class.forName(DRUVER_CLASS_NAME);
