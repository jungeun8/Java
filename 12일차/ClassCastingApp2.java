...
public class ClassCastingApp2 {
	...
	public static void main(String[] args) {
		...
		//PoliceCar car12 = (PoliceCar)car1; // 실행오류,car1이 참조하는 객체에는 PoiceCar가 없음
		//car12.patrol();
		...
		PoliceCar car22 = (PoliceCar) car2;		//car2로 참조되는 객체에서 PoliceCar객체로 옮겨가기  
		car22.patrol();	// PoliceCar객체의 기능 사용하기 
		
		System.out.println("####Car타입의 참조변수로 Panzer객체 참조하기");
		car1.drive();	// car객체의 기능 사용하기 
		car1.stop();	// car객체의 기능 사용하기 
		PoliceCar car32 = (PoliceCar) car2;		//car3로 참조되는 객체에서 PoliceCar객체로 옮겨가기  
		car32.patrol();	// PoliceCar객체의 기능 사용하기
		Panzer car33 = (Panzer)car3;	//car3로 참조되는 객체에서 PoliceCar객체로 옮겨가기  
		car33.fireWeapon();
	}
